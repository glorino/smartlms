...
export default function NewCoursePage() {
  ...
  const [sections, setSections] = useState<Section[]>([
    {
      ...
      title: "Section 1",
      lessons: [
        { id: "1", title: "Introduction", duration: "10:00", type: "VIDEO" },
      ],
    },
  ]);
  ...
  const handleThumbnailUpload = () => {
    setThumbnail("/placeholder-thumbnail.jpg");
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-gray-600">Fill in the details to create your course</p>
        </div>
      </div>
        ...
        <div className="space-y-6 lg:col-span-2">
                  ...
                  <div className="mt-3 ml-7 space-y-2">
                    {section.lessons.map((lesson, lIdx) => (
                      ...
                      >
                        ...
                        <Badge variant={lesson.type === "VIDEO" ? "default" : lesson.type === "QUIZ" ? "warning" : "secondary"} className="text-xs">
                          {lesson.type}
                        </Badge>
                        <input
                          type="text"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add a quiz to test student knowledge</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4">
                <Input
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-500 mt-7">Questions will be created after course is published</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button className="w-full gap-2" onClick={() => alert("Course published!")}>
                <Send className="h-4 w-4" />
                Publish Course
              </Button>
              <Button variant="outline" className="w-full gap-2" onClick={() => alert("Draft saved!")}>
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{quizQuestions}</span>
              </div>
              <div className="flex justify-between">
