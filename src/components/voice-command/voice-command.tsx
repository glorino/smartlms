...
const NAV_COMMANDS: VoiceCommand[] = [
  { patterns: [/verify\s*certificate/i, /verify\s*cert/i, /certificate\s*verify/i, /check\s*certificate/i, /validate\s*certificate/i], action: "navigate", target: "/verify-certificate", description: "certificate verification", speakResponse: "Opening certificate verification." },
  { patterns: [/live\s*class/i, /live\s*session/i, /webinar/i, /stream/i, /join.*live/i, /online\s*class/i], action: "navigate", target: "/live-classes", description: "live classes", speakResponse: "Opening live classes." },
  ...
  { patterns: [/courses?/i, /browse/i, /learn/i, /lesson/i, /training/i], action: "navigate", target: "/courses", description: "courses", speakResponse: "Opening courses." },
  ...
  { patterns: [/message/i, /inbox/i, /mail/i], action: "navigate", target: "/dashboard/messages", description: "messages", speakResponse: "Opening messages." },
  { patterns: [/assignment/i, /homework/i, /task/i, /submit/i], action: "navigate", target: "/dashboard/assignments", description: "assignments", speakResponse: "Opening assignments." },
  ...
  { patterns: [/register/i, /sign\s*up/i, /create.*account/i], action: "navigate", target: "/register", description: "registration", speakResponse: "Opening registration." },
  ...
  { patterns: [/become\s*instructor/i, /teach\s*on/i, /start\s*teaching/i], action: "navigate", target: "/become-instructor", description: "become an instructor", speakResponse: "Opening become an instructor page." },
  ...
  { patterns: [/help/i, /assist/i], action: "navigate", target: "/help", description: "help center", speakResponse: "Opening help center." },
  { patterns: [/support/i, /contact/i], action: "navigate", target: "/support", description: "support", speakResponse: "Opening support page." },
  { patterns: [/enterprise/i, /business/i, /team\s*plan/i], action: "navigate", target: "/enterprise", description: "enterprise", speakResponse: "Opening enterprise page." },
  { patterns: [/privacy/i, /data\s*protection/i], action: "navigate", target: "/privacy", description: "privacy policy", speakResponse: "Opening privacy policy." },
  { patterns: [/terms/i, /conditions/i, /terms\s*of/i], action: "navigate", target: "/terms", description: "terms of service", speakResponse: "Opening terms of service." },
  { patterns: [/docs/i, /documentation/i, /docs/i], action: "navigate", target: "/docs", description: "documentation", speakResponse: "Opening documentation." },
  { patterns: [/demo/i, /try/i, /sample/i], action: "navigate", target: "/demo", description: "demo", speakResponse: "Opening demo page." },
  { patterns: [/forgot.*password/i, /reset.*password/i, /password\s*reset/i], action: "navigate", target: "/forgot-password", description: "password reset", speakResponse: "Opening password reset." },
  { patterns: [/performance/i, /progress/i, /stats/i, /analytics/i], action: "navigate", target: "/dashboard/performance", description: "performance", speakResponse: "Opening your performance." },
  { patterns: [/achievement/i, /badges/i, /rewards/i], action: "navigate", target: "/dashboard/achievements", description: "achievements", speakResponse: "Opening your achievements." },
  { patterns: [/training/i], action: "navigate", target: "/dashboard/training", description: "training", speakResponse: "Opening training." },
  { patterns: [/onboarding/i, /getting\s*started/i, /start/i], action: "navigate", target: "/dashboard/onboarding", description: "onboarding", speakResponse: "Opening onboarding." },
  { patterns: [/my\s*courses/i, /enrolled/i], action: "navigate", target: "/dashboard/my-courses", description: "my courses", speakResponse: "Opening your courses." },
  { patterns: [/activity/i, /history/i, /recent/i], action: "navigate", target: "/dashboard/activity", description: "activity", speakResponse: "Opening your activity." },
];
